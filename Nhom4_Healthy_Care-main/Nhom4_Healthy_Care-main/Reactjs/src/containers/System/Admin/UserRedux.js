...
class UserRedux extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            placeholder = "nhoxtuananh@gmail.com"
            value = { email }
            onChange = {
            ...
            div className = 'row-12' >
            <
            button className = { this.state.action === CRUD_ACTIONS.EDIT ? "btn btn-warning mt-3 px-3" : "btn btn-primary mt-3 px-3" }
            onClick = {
                () => this.handleSaveUser()
            } >
            ...
            <
            label > < FormattedMessage id = { 'manage-user.image' }
            /></label >
            <
